...
RUN_ID="${1:-hf-sentence-id-head-deprel-eval-001}"
MODEL="${MODEL:-Qwen/Qwen2.5-0.5B-Instruct}"
ADAPTER_PATH="${ADAPTER_PATH-hf_outputs/qwen25-05b-sentence-id-head-deprel-a100-lora-full}"
SYSTEM_NAME="${SYSTEM_NAME:-hf_lora_sentence_id_head_deprel}"
TEST_FILE="${TEST_FILE:-latin_sentence_id_head_deprel_data/test.jsonl}"
...
python scripts/render_sentence_id_head_deprel_to_conllu.py \
...
if ! python scripts/render_sentence_id_head_deprel_to_conllu.py \
    --input-jsonl "$TEST_FILE" \
