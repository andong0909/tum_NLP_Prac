...
SYSTEM_PROMPT = (
    ...
    "HEAD must be 0 or another token ID. HEAD must never equal ID. "
    "Exactly one row must have HEAD=0. The dependencies must form one acyclic tree."
)
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert full CoNLL-U chat JSONL into sentence-level ID/HEAD/DEPREL JSONL with tree constraints."
    )
